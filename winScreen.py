...
class WinScreen:
    ...
    def displayWinScreen(self):
        ...
        if self.__result == "win":
            self.__canvas.create_text(self.__canvasConfig[0], self.__canvasConfig[1], fill="white", font=("Courier", 90, "bold"), justify="center", text=self.__textWin)
        elif self.__result == "egal":
            self.__canvas.create_text(self.__canvasConfig[0], self.__canvasConfig[1], fill="white", font=("Courier", 90, "bold"), justify="center", text=self.__textEgal)
